...
We look forward to hearing from you and discussing how we can help to bring your ideas to life.​
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-body-color text-base">yourfriends@uinvented.com</p>
                  </div>
                </div>
              </div>
            </div>

            <div class="w-1/2 px-4 lg:w-1/2 xl:w-5/12">
            ...
            >
              ...
              {loading && (
 <div role="status" >
     <svg aria-hidden="true" role="status" class="inline w-8 h-8 mr-3 ml-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
