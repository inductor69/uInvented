    ...
    <nav className="bg-white border-gray-200 px-2 sm:px-4 py-5 rounded">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="flex md:order-2">
          <button type="button" className="text-white bg-black hover:bg-white-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get started</button>
