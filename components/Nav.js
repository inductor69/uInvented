...
export default function Nav() {
  return (
    ...
    <nav className="bg-white border-gray-200 px-2 sm:px-4 py-5 rounded">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <a href="#" className="flex">
          ...
          <span className="self-center text-lg font-semibold whitespace-nowrap dark:text-white">uInvented</span>
        </a>
        <div className="flex md:order-2">
          <button type="button" className="text-white bg-black hover:bg-white-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 ">Get started</button>
        ...
        <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-4">
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            <li>
              <a href="#" className="block py-2 pr-4 pl-3 text-white bg-black rounded md:bg-transparent md:text-blue-700 md:p-0 " aria-current="page">Home</a>
            </li>
            <li>
